...
const Loader = () => {
  return (
    <section className="flex w-[100vw] h-[100vh] items-center justify-center absolute z-99999999 bg-white/30">
      <div className=" w-50 h-50 fixed flex items-center justify-center">
